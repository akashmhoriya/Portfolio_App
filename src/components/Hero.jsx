...
import CV from "../assets/Akash_Saini_Resume.pdf";
...
const Hero = ({ darkMode }) => {
  const socialIcons = [
    {
      icon: linkedin,
      alt: "Linkedin",
      link: "https://www.linkedin.com/in/akashmhoriya/",
    },
    { icon: github, alt: "Github", link: "https://github.com/akashmhoriya" },
  ...
  return (
    <div className="relative overflow-hidden min-h-screen flex flex-col">
      ...
      >
        <div className="container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-14 flex-col lg:flex-row items-center justify-between lg:mt-40 mt-20">
          <div className="lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0">
            ...
            >
              ...
              design and smooth user experience. Using React, Tailwind CSS, and
              Framer Motion, I turn ideas into interactive and engaging digital
              products.
            </p>
            {/* Buttons */}
          ...
          >
            <div className="relative w-4/5 sm:w-3/4 lg:w-full">
              ...
              <img
                src={hi}
                alt="Hi icon"
                className="absolute top-[5%] left-[10%] sm:top-[8%] sm:left-[15%] lg:top-[7%] lg:left-[10%] w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 object-contain animate-bounce opacity-90 z-10"
              />
            </div>
          </div>
        </div>
